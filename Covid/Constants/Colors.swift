...
enum Colors {
    ...
    static let whiteClear = UIColor(red: 245/255.0, green: 245/255.0, blue: 245/255.0, alpha: 0.3)
    static let black = UIColor(red: 30/255.0, green: 30/255.0, blue: 40/255.0, alpha: 1)
    static let blackClear = UIColor(red: 30/255.0, green: 30/255.0, blue: 40/255.0, alpha: 0.5)
}
