...
final class GraphLog: UIView {
    ...
    private let graphConfirmedColor: UIColor = Colors.orange
    private let graphDeathsColor: UIColor = Colors.red
    private let graphRecoveredColor: UIColor = Colors.green
    private let clippingConfirmedColor: UIColor = Colors.lightOrange
    private let clippingDeathsColor: UIColor = Colors.lightRed
    private let clippingRecoveredColor: UIColor = Colors.lightGreen
    ...
    private func getYMax() -> Int {
        var everest = 100
        guard let maxPoint = yConfirmedData.max() else { return everest }
